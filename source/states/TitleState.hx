...
class TitleState extends MusicBeatState
{
	...
	var HackerColors:Array<FlxColor> = [FlxColor.RED, 0xFFFCE97D, 0xFF770303, FlxColor.LIME];
	...
	function createCoolText(textArray:Array<String>, ?offset:Float = 0)
	{
		for (i in 0...textArray.length)
		{
			...
			money = new FlxText(0, 0, 0, textArray[i], 50);
			money.setFormat("RobloxFont-Regular.ttf", 90, FlxColor.RED);
	...
	function addMoreText(text:String, ?offset:Float = 0)
	{
		if(textGroup != null && credGroup != null) {
			...
			coolText = new FlxText(0, 0, 0, text, 50);
			coolText.setFormat("RobloxFont-Regular.ttf", 90, FlxColor.RED);
	...
	override function beatHit()
	{
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['Terminal Engine by'], 40);
				case 4:
					addMoreText('Dad', 40);
				case 5:
					deleteCoolText();
				...
				case 8:
					addMoreText('Meero + Terminal Team', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
			...
			/* didnt go as planned ;-;
			switch([money, coolText]) {
				case [null, null]:
					return;
				case [_, null]:
					money.color = HackerColors[sickBeats % HackerColors.length];
				case [null, _]:
					coolText.color = HackerColors[sickBeats % HackerColors.length];
				case [_, _]:
					money.color = HackerColors[sickBeats % HackerColors.length];
					coolText.color = HackerColors[sickBeats % HackerColors.length];
			}
