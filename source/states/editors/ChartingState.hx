...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Slash', "Ohh this is going 2 be fun >:)\nValue 1: How long would the ENTIRE slash be\n \nValue 2: How many times does he slash repeatedly(1 is default btw)\n \nharley ik your gonna abuse it so DONT U DARE OR ELSE >:(\n \n(btw if you put value 2 zero then slashes will loop forever >:D)"],
		['FlipShitDoe', "Confusing Lol\nValue 1:How long it will be"],
		['Spin', 'You spin me right round, baby, right round\nLike a record, baby, right round, round, round Ahh shit Lol\n \nValue 1: How many seconds until it stops or keep spinning\n \nValue 2: How many times does the arrow spin\n \nIn Value 2 Make Sure that You take how many times and multiply by 2\nfor example if u want 6 times to spin put 12 in value'],
