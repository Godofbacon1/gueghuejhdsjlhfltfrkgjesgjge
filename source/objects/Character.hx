...
class Character extends FlxSprite
{
	...
	**/
	...
	public function changeCharacter(character:String)
	{
		...
		try
		{
			if (FileSystem.exists(path)) loadCharacterFile(Json.parse(File.getContent(path)));

			else if (Assets.exists(path)) loadCharacterFile(Json.parse(Assets.getText(path)));
		}
		catch(e:Dynamic)
		{
